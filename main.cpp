...
// Define flags to control rain rendering and night mode
bool isRaining = false;
bool isNightMode = false;

// Function to render rain
void drawRain() {
    glColor3ub(0, 153, 204); // Set the rain color (a more noticeable blue)
    glBegin(GL_LINES);
    for (int i = 0; i < 500; i++) { // Increase the number of rain drops
        int x = rand() % 1450;
        int y = rand() % 750;
        glVertex2f(x, y);
        glVertex2f(x, y - 20); // Increase the length of rain lines
    }
    glEnd();
}

// Function to update background color based on the current mode
void updateBackgroundColor() {
    if (isNightMode) {
        glClearColor(0.0, 0.0, 0.0, 1.0); // Black background for night mode
    } else {
        glClearColor(1.0, 1.0, 1.0, 1.0); // White background for normal mode
    }
}
...
void display ()
{
    ...
    // Add your existing drawing code here
    // ...
    ...
    // Add your existing swap and flush code here
    glutSwapBuffers();
    glFlush();
...
/////////////****
    ...
    // Setting the color and position for each character in "CSE DEPARTMENT"
// Adjust the positions as necessary to align the text correctly

// Render "C"
    glColor3ub(0, 51, 204);
    glRasterPos2i(115, 465);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'C');

// Render "S"
    glColor3ub(115, 115, 115);
    glRasterPos2i(121, 465);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'S');

// Render "E"
    glColor3ub(0, 102, 34);
    glRasterPos2i(126, 465);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'E');

// Render space
    glColor3ub(0, 0, 0); // Default color for space, usually not visible
    glRasterPos2i(131, 465);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, ' ');

// Render "D"
    glColor3ub(0, 51, 204);
    glRasterPos2i(136, 465);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'D');

// Render "E"
    glColor3ub(115, 115, 115);
    glRasterPos2i(141, 465);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'E');

// Render "P"
    glColor3ub(0, 102, 34);
    glRasterPos2i(146, 465);
...
///white part///
    ...
    // Set color and position for each character in "ELL department"
    glColor3ub(0, 51, 204);
...
// Render "d"
    glRasterPos2i(522, 455);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'D');

// Render "e"
    glRasterPos2i(527, 455);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'E');

// Render "p"
    glRasterPos2i(532, 455);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'P');

// Render "t"
    glRasterPos2i(537, 455);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'T');
    ...
    glColor3ub(31, 46, 53);
    glRasterPos2i(392,270);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10,'I');
    glColor3ub(31, 46, 53);
    glRasterPos2i(396,270);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10,'I');
    glColor3ub(31, 46, 53);
    ...
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10,'R');
    glColor3ub(31, 46, 53);
    glRasterPos2i(440,270);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10,'I');
    glColor3ub(31, 46, 53);
    glRasterPos2i(444,270);
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10,'A');
...
// Set the position for the first line of text (name)
    glRasterPos2i(285, 780);

// Render "A PROJECT BY MDATAULISLAM"
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'A');
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, ' ');
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'P');
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'R');
...
// Set the position for the second line of text (INTERNATIONAL ISLAMIC UNIVERSITY CHITTAGONG)
    glRasterPos2i(285, 760); // Adjust y position to render the second line below the first

// Render "INTERNATIONAL ISLAMIC UNIVERSITY CHITTAGONG"
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'I');
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'N');
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'T');
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'E');
...
// Set the position for the third line of text (matric ID)
    glRasterPos2i(285, 740); // Adjust y position to render the third line below the second

// Render "MATRIC ID - C213107"
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'M');
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'A');
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'T');
    glutBitmapCharacter(GLUT_BITMAP_TIMES_ROMAN_10, 'R');
